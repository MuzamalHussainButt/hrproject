...
class InterviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interview" do
    assert_difference('Interview.count') do
      post interviews_url, params: { interview: { description: @interview.description, employee_detail_id: @interview.employee_detail_id, name: @interview.name, title: @interview.title } }
    end
  ...
  test "should update interview" do
    patch interview_url(@interview), params: { interview: { description: @interview.description, employee_detail_id: @interview.employee_detail_id, name: @interview.name, title: @interview.title } }
